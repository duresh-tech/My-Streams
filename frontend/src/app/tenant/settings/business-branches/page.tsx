...
export default function TenantBusinessBranchesPage() {
  ...
  const list = useResourceList<TenantBusinessBranchRow>("/tenant/business-branches", {}, tenantApi);
  ...
  function loadBusinessOptions(): Promise<BusinessOption[]> {
    ...
    return tenantApi<BusinessOption[]>("/tenant/business-branches/businesses")
      .then((data) => {
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (editing) {
        await tenantApi(`/tenant/business-branches/${editing.id}`, { method: "PATCH", body });
        toast.success("Branch updated");
      } else {
        await tenantApi("/tenant/business-branches", { method: "POST", body });
  ...
  async function onDelete() {
    ...
    setDeleting(true);
    try {
      await tenantApi(`/tenant/business-branches/${deleteTarget.id}`, { method: "DELETE" });
  ...
  return (
    <>
      <ResourceTable<TenantBusinessBranchRow>
        ...
        description="Branch locations for your business."
        columns={columns}
        rows={list.rows}
        error={list.error}
        page={list.page}
        ...
        <DialogContent>
          <form onSubmit={onSubmit}>
            <DialogHeader>
              ...
              <DialogDescription>Branch location for your business.</DialogDescription>
            </DialogHeader>
      ...
      <ConfirmDialog
        ...
        title="Delete branch"
        description={`This will delete "${deleteTarget?.branchName}".`}
        loading={deleting}
        onConfirm={onDelete}
      />
    </>
